...
- [x] Un outil de Doctrine permettant de convertir les paramètres d'une action en entrée dans une table de la BdD
...
- `{{ 'Ceci est une traduction'|trans({}, 'front') }}` << la bonne réponse